...
Project prototype routes open the structured Studio. The source of truth is a typed prototype document plus command journal and checkpoints, not stored HTML. Users can drag elements, model runtime flows, publish immutable revisions, and ask the project-bound Claude Code UI Engineer to propose or generate schema-validated changes through dedicated MCP tools.
