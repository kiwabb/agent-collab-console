...
// Shared fetch infrastructure lives in lib/api/fetch.ts (Phase 4b
// extraction). Re-exported here for the existing call sites.
import {
  API_BASE,
  WS_BASE,
...
export { API_BASE, WS_BASE, formatApiErrorDetail, dedupedFetch, handleResponse };
