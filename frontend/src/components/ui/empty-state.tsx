...
const illustrations = {
  ...
  artifact: (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M12 12l8-8h24l8 8v40l-8 8H20l-8-8V12z"
        stroke="currentColor"
        strokeWidth="2"
        strokeDasharray="4 2"
        opacity="0.3"
  ...
  message: (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M8 12c0-2.2 1.8-4 4-4h40c2.2 0 4 1.8 4 4v28c0 2.2-1.8 4-4 4H20l-8 8V12z"
        stroke="currentColor"
        strokeWidth="2"
        strokeDasharray="4 2"
        opacity="0.3"
...
export function EmptyState({
  ...
  return (
    ...
    >
      <div className="text-text-muted/30">{illustrations[icon]}</div>
      <div className="space-y-1">
        <p className="text-sm font-bold text-text-muted">{title}</p>
        {description && <p className="text-xs text-text-muted/60 max-w-xs">{description}</p>}
      </div>
