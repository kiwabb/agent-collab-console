...
from contextlib import asynccontextmanager  # noqa: I001, RUF100
...
async def lifespan(app: FastAPI):
    ...
    try:
        from benchmark import api as benchmark_api  # noqa: I001
    ...
    try:
        from app.bootstrap import async_store  # noqa: I001
    ...
    try:
        from app.bootstrap import async_store, WORKFLOW_DAG_ENABLED  # noqa: I001
    ...
    try:
        from app.bootstrap import async_store, get_codex_process_manager  # noqa: I001
