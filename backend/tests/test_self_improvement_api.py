...
def test_project_self_improvement_proposal_patch_returns_404_for_unknown_project_or_proposal(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_patch_returns_503_when_store_unavailable(
    client, monkeypatch
):
...
def test_project_self_improvement_proposal_apply_plan_requires_accepted_status(
    client, tmp_path, status
):
...
def test_project_self_improvement_proposal_apply_plan_returns_404_for_unknown_or_cross_project(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_apply_plan_returns_503_when_store_unavailable(
    client, monkeypatch
):
    from app.interfaces import api as api_module
...
def test_project_self_improvement_proposal_activate_task_creates_issue_worktree_and_event(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_activate_task_can_start_conductor(
...
def test_project_self_improvement_proposal_activate_task_reuses_issue_when_starting_conductor_twice(
    ...
    assert starts == [
        first.json()["activation"]["issue"]["id"],
        first.json()["activation"]["issue"]["id"],
    ]
    ...
    assert (
        len(
            [
                issue
                for issue in issues
                if issue["title"].startswith("Apply self-improvement proposal:")
            ]
        )
        == 1
    )
...
@pytest.mark.parametrize("status", ["proposed", "rejected", "applied"])
def test_project_self_improvement_proposal_activate_task_requires_accepted_status(
    client, tmp_path, status
):
...
def test_project_self_improvement_proposal_activate_task_returns_404_for_unknown_or_cross_project(
    client, tmp_path
):
    ...
    _seed_proposal(
        _proposal(source_project["id"], target_kind="runtime_tooling", status="accepted")
    )
...
def test_project_self_improvement_proposal_activate_task_rejects_missing_source_issue(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_activate_task_records_failed_event_on_worktree_error(
    ...
    monkeypatch.setattr(
        api_module.worktree_manager, "prepare_issue_worktree", fail_prepare_issue_worktree
    )
...
def test_project_self_improvement_proposal_activate_task_returns_503_when_store_unavailable(
    client, monkeypatch
):
    from app.interfaces import api as api_module
...
def test_project_self_improvement_proposal_apply_project_memory_appends_and_marks_applied(
    client, tmp_path
):
    ...
    assert resp.status_code == 200, resp.text
    body = resp.json()
    memory_content = (tmp_path / name / ".agent-collab" / "team_notes.md").read_text(
        encoding="utf-8"
    )
...
def test_project_self_improvement_proposal_apply_project_memory_skips_existing_marker(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_apply_rejects_hash_mismatch_without_writing(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_apply_rejects_non_memory_target_without_writing(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_apply_returns_404_for_unknown_or_cross_project(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_apply_returns_503_when_store_unavailable(
    client, monkeypatch
):
    from app.interfaces import api as api_module
...
def test_project_self_improvement_proposal_applications_endpoint_lists_project_scoped_events(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_applications_endpoint_hides_cross_project_proposal(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_applications_endpoint_returns_503_when_store_unavailable(
    client, monkeypatch
):
    from app.interfaces import api as api_module
    ...
    resp = client.get(
        "/api/codex/projects/project-1/self-improvement-proposals/proposal-1/applications"
    )
...
def test_project_self_improvement_proposal_apply_records_succeeded_application_event(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_rollback_removes_memory_block_and_marks_accepted(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_rollback_is_idempotent_when_marker_absent(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_rollback_rejects_non_applied_status_without_status_change(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_rollback_rejects_non_memory_target_without_status_change(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_rollback_returns_404_for_unknown_or_cross_project(
    client, tmp_path
):
...
def test_project_self_improvement_proposal_rollback_returns_503_when_store_unavailable(
    client, monkeypatch
):
    from app.interfaces import api as api_module
    ...
    resp = client.post(
        "/api/codex/projects/project-1/self-improvement-proposals/proposal-1/rollback"
    )
